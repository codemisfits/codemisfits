...
<section class="register" id="register">
    ...
    <form action="">
        ...
        <input type="phone" name=""placeholder="enter your mobile number" id=""class="box">
        <input type="ministry" name=""placeholder="enter your appointed office" id=""class="box">
        <input type="date of appointment" name=""placeholder="enter your appointment date" id=""class="box">
